    ...
    describe("#create", function()
        describe("when attrs are specified", function()
            it("creates a new entry", function()
                ...
                assert.is.number(sql:find("seen_at", 20, true))
                assert.is.number(sql:find("last_name", 20, true))
                assert.is.number(sql:find("first_name", 20, true))
                assert.is.number(sql:find("age", 20, true))
                assert.is.number(sql:find("'q-2013-10-12T16:31:21 UTC'", 62, true))
                assert.is.number(sql:find("'q-gin'", 62, true))
                assert.is.number(sql:find("'q-roberto'", 62, true))
                assert.is.number(sql:find("3", 62, true))
            end)
        end)
            ...
            describe("when attrs are a table", function()
                describe("when no options are specified", function()
                    it("finds and returns models without options", function()
                        ...
                        assert.is.number(sql:find("seen_at='q-2013-10-12T16:31:21 UTC'",28,true))
                        assert.is.number(sql:find("last_name='q-gin'",28,true))
                        assert.is.number(sql:find("first_name='q-roberto'",28,true))
                        assert.is.number(sql:find("age=3",28,true))
                    end)
                end)
            ...
            describe("when attrs are a table", function()
                describe("when no options are specified", function()
                    it("calls .delete_where", function()
                        ...
                        assert.is.number(sql:find("seen_at='q-2013-10-12T16:31:21 UTC'",26,true))
                        assert.is.number(sql:find("last_name='q-gin'",26,true))
                        assert.is.number(sql:find("first_name='q-roberto'",26,true))
                        assert.is.number(sql:find("age=3",26,true))
                    end)
                end)
        ...
        describe("when attrs are specified", function()
            describe("when no where is specified", function()
                it("calls .update_where", function()
                    ...
                    assert.is.number(sql:find("seen_at='q-2013-10-12T16:31:21 UTC'",18,true))
                    assert.is.number(sql:find("last_name='q-gin'",18,true))
                    assert.is.number(sql:find("first_name='q-roberto'",18,true))
                    assert.is.number(sql:find("age=3",18,true))
                end)
            end)
            ...
            describe("when where is specified", function()
                describe("and where is a table", function()
                    it("calls .update_where", function()
                        ...
                        assert.are.equal(");",sql:sub(-2))
                        assert.is.number(sql:find(" AND ",-39,true))
                        assert.is.number(sql:find("first_name='q-robbb'",-39,true))
                        assert.is.number(sql:find("id=4",-39,true))
                        assert.is.number(sql:find("seen_at='q-2013-10-12T16:31:21 UTC'",18,true))
                        assert.is.number(sql:find("last_name='q-gin'",18,true))
                        assert.is.number(sql:find("first_name='q-roberto'",18,true))
                        assert.is.number(sql:find("age=3",18,true))
